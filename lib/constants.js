const CATEGORIES = [
  ...
  { name: 'Cartofi și ceapă', icon: '🥔', color: '#6d4c41', image: '/images/cat-cartofi-ceapa.jpg' },
  ...
  { name: 'Dulcețuri', icon: '🍓', color: '#c2185b', image: '/images/cat-dulceturi.jpg' },
  { name: 'Carne și ouă', icon: '🍗', color: '#c62828', image: '/images/cat-carne.jpg' },
  { name: 'Pește', icon: '🐟', color: '#0277bd', image: '/images/cat-peste.jpg' },
